...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="chiaroscuro-dark" style="display: flex; min-height: 100vh; align-items: center; justify-content: center; background-color: var(--color-surface); font-family: var(--font-body);">
        
        <div style="width: 100%; max-width: 400px; padding: 40px; background: var(--color-black); border-radius: 4px; box-shadow: 0 20px 40px rgba(0,0,0,0.5); text-align:center; border: 1px solid var(--color-border-dark);">

...
<div x-data="cartSystem()" x-init="initCart()">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 30px;">
        ...
        <button class="btn-standard" @click="isCartOpen = true" style="position:relative; padding: 12px 24px; border-width: 2px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; display: flex; align-items: center; gap: 8px; overflow: visible !important;">
            ...
            <span x-show="totalItems > 0" x-text="totalItems" style="position:absolute; top:-6px; right:-6px; background:var(--color-red); color:white; border-radius:50%; width:22px; height:22px; font-size:11px; display:flex; justify-content:center; align-items:center; font-weight:900; border: 2px solid white; box-shadow: 0 2px 5px rgba(0,0,0,0.3); z-index: 100; pointer-events: none; padding-top: 4px;"></span>
        </button>
    </div>

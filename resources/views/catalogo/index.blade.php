...
<div x-data="cartSystem()" x-init="initCart()">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 30px;">
        ...
        <!-- Cart Trigger -->
        <button class="btn-standard" @click="isCartOpen = true" style="position:relative; padding: 10px 20px;">
            <i class="ph ph-shopping-bag"></i> Mi Pedido
            <span x-show="totalItems > 0" x-text="totalItems" style="position:absolute; top:-10px; right:-10px; background:var(--color-red); color:white; border-radius:50%; width:20px; height:20px; font-size:12px; display:flex; justify-content:center; align-items:center; font-weight:bold;"></span>
        </button>
    </div>

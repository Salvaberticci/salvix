...
<div x-data="kanban()" class="kanban-board" style="display:flex; gap:20px; overflow-x:auto; padding-bottom:20px; align-items:flex-start; height:calc(100vh - 150px);">
    ...
    <!-- Column -->
    <div style="min-width: 300px; flex:1; background:#f4f6f8; padding:15px; border-radius:4px; height:auto; min-height:400px; border-top: 4px solid @if($key=='pendiente') #F13A2C @elseif($key=='cocina') var(--color-modena-yellow) @elseif($key=='listo') #4C98B9 @else #03904A @endif; border-left: 1px solid var(--color-border-dark); border-right: 1px solid var(--color-border-dark); border-bottom: 1px solid var(--color-border-dark); box-shadow: inset 0 0 10px rgba(0,0,0,0.02);">
